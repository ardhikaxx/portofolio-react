...
export default function Hero() {
  ...
  return (
    <section className="w-full dark:bg-gray-100 bg-black  dark:bg-grid-black/[0.1] bg-grid-white/[0.2] relative overflow-hidden py-2 z-10">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-gray-100 bg-dark [mask-image:radial-gradient(ellipse_at_center,transparent_20%,white)]"></div>
