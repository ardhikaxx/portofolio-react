      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 mt-10 md:pb-20">
          <div className="text-center pb-12 md:pb-16 relative z-10">
            <div className="flex items-center justify-center gap-2" data-aos="zoom-y-out">
              <Image className="inline -mt-4" src={LogoImage} width={100} height={100} alt="Logo" />
              <h1 className="text-3xl md:text-5xl font-extrabold leading-tighter tracking-tighter mb-4 flex items-center">Hello, I'm <span className="bg-clip-text ml-3 text-transparent bg-gradient-to-r from-[#4895D1] to-[#78B1E5]">Yanuar Ardhika</span></h1>
            </div>
