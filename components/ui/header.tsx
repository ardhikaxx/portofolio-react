        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link href="https://www.instagram.com/ardhikkaaa_/" target='_blank' className={`font-semibold ${scrolled ? 'text-black hover:text-gray-700' : 'text-black'} hover:text-gray-700 px-5 py-3 flex font-bold items-center transition duration-150 ease-in-out`}>Contact Me</Link>
              </li>
              <li>
                <button
