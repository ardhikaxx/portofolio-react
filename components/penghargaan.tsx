...
const Awards = () => {
    return (
        <section className="relative py-20 dark:bg-gray-900 to-white">

            <div className="max-w-7xl mx-auto px-5 sm:px-10">
                <div className="text-center mb-12 flex flex-col justify-center items-center">
                    <h1 className="text-3xl font-bold text-white" data-aos="zoom-y-out">My Awards</h1>
                    <p className="text-xl text-gray-300" data-aos="zoom-y-out" data-aos-delay="150">Here are some of the awards I have received for my work.</p>
                </div>
                    ...
                    {penghargaanData.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="relative p-6 h-full flex flex-col z-10">
                                <div className="mb-5">
                                    <div className="w-14 h-14 rounded-xl bg-[#B51D2A] bg-opacity-10 flex items-center justify-center mb-4">
                                ...
                                <div className="mt-auto pt-5 border-t border-gray-100 group-hover:border-blue-100 transition-colors flex justify-between items-center">
                                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-[#B51D2A] bg-opacity-10 text-[#B51D2A]">
                                        {item.tahun}
                                    </span>
                                    <span className="text-sm font-semibold py-1 px-3 rounded-full bg-[#B51D2A] bg-opacity-10 text-[#B51D2A]">
                                        Achievements
                                    </span>
                                </div>
                            </div>
